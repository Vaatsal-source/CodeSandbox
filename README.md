...
GET /api/history: Returns all saved execution sessions.

DELETE /api/history/{session_id}: Deletes a saved session by ID.

WS /ws/agent: WebSocket endpoint used by the frontend to stream agent execution updates.
